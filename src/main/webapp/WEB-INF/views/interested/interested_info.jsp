...
<html lang="ko">
  ...
  <body>
            ...
            <div class="">
              <div class="row">
                <div class="dropdown col-6">
                  <button
                    ...
                    onclick="getInterestedAreaListLeft()"
                  >
                    관심지역 선택하기
                  </button>
              ...
              <div class="mb-2">
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#left_hospital">코로나 안심 병원</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#left_center"
                      >코로나 선별 진료소</a
                    >
                  </li>
                </ul>
          ...
          <div class="col-md-6 col-lg-6">
            <div class="">
              <div class="row">
                <div class="dropdown col-6">
                  <button
                    ...
                    class="btn btn-primary dropdown-toggle"
                    data-toggle="dropdown"
                    onclick="getInterestedAreaListRight()"
                  >
                    관심지역 선택하기
                  </button>
              ...
              <div class="mb-2">
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#right_hospital"
                      >코로나 안심 병원</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#right_center"
                      >코로나 선별 진료소</a
                    >
                  </li>
                </ul>
    ...
    <script
      ...
      src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c4c8e04658a5aa22ab7e8258713d9b0e&libraries=services"
    ></script>
