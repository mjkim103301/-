									...
									<article class="card-body mx-auto" style="max-width: 400px;">
										...
										<form id="updateform" method="post" action="post">
											...
											<div class="form-group">
												<button type="button" class="btn btn-primary btn-block" onclick="javascript:updateMember();">수정하기</button>
											</div>
											<!-- form-group// -->
										</form>
									</article>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-danger logout-nav" onclick="location.href='index.html'">확인</button>
