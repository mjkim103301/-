  ...
  <div>
    ...
    <table class="table table-condensed w-25">
      <tr>
        <th>제목</th>
        <td>
          <input type="text" id="subject" ref="subject" placeholder="제목을 입력해주세요" v-model="article.subject" />
        </td>
      </tr>
      <tr>
        <th>내용</th>
        <td>
          <textarea id="content" cols="30" rows="10" ref="content" v-model="article.content"></textarea>
        </td>
      </tr>
    </table>
