<template>
  <div>
    ...
    <div class="text-right">
      <router-link class="btn btn-primary" :to="`/happyhouse/article`">목록</router-link>
      <router-link class="btn btn-primary" :to="'/update?no=' + article.articleId">수정</router-link>
      <router-link class="btn btn-primary" :to="'/remove?no=' + article.articleId">삭제</router-link>
    </div>
  </div>
</template>
<script>
